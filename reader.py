...
# add the longitude column in a not-so-nice way
    temp['longitude'] = lon
# substract baseline using polynomial or gaussian fit
# ... 
# print spectrum in png format, disabled by default
...
mw['doppler'] = 299792458*((mw['frequency power [Hz]'] - 1420.45)/1420.45)
